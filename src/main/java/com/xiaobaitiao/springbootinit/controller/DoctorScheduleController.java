...
public class DoctorScheduleController {
    ...
    public BaseResponse<List<DoctorScheduleRankVO>> getDoctorScheduleRankTop10() {
        List<DoctorScheduleRankVO> rankList = doctorScheduleService.getDoctorScheduleRankTop10();
