...
public class SparkAIManager extends WebSocketListener {
    ...
    public static final String appid = "59b825f2";
    // todo 替换成你自己的 apiSecret 图书管理系统 1.1 版本
    public static final String apiSecret = "YzYxYzgzODdkNDE4ZDI3NWNmMDA2YTdm";
    // todo 替换成你自己的 apiKey 图书管理系统 1.1 版本
    public static final String apiKey = "44857f82f54f8c1a267f6e3c48a053d6";
