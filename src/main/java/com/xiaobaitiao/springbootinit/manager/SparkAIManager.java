...
public class SparkAIManager extends WebSocketListener {
    ...
    public static final String hostUrl = "https://spark-api.xf-yun.com/v1.0/chat";
    // todo 替换成你自己的 appid 图书管理系统 1.1 版本 1.2版本请找 AiIntelligentServiceImpl 替换代码块即可
    public static final String appid = "xxxxxxxxxxxxxx";
    // todo 替换成你自己的 apiSecret 图书管理系统 1.1 版本
    public static final String apiSecret = "xxxxxxxxxxxxxxxxx";
    // todo 替换成你自己的 apiKey 图书管理系统 1.1 版本
    public static final String apiKey = "xxxxxxxxxxxxxxxxxxxxxxx";
