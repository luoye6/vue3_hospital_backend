...
public class UserAiMessageController {
     ...
     */
    @PostMapping("/add")
    public BaseResponse<Long> addUserAiMessage(@RequestBody UserAiMessageAddRequest userAiMessageAddRequest, HttpServletRequest request) {
        ...
        return ResultUtils.success(newUserAiMessageId);
    }
